...
const HabitCard: React.FC<HabitCardProps> = ({ habit, onDelete, onComplete, onEdit }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative p-4 sm:p-6 flex flex-col h-full">
        ...
        {habit.description && (
          <p className="text-gray-700 mb-4 text-sm leading-relaxed break-words">{habit.description}</p>
        )}
        ...
        <button
          ...
          className={`w-full py-2 px-4 rounded-lg font-medium text-sm sm:text-base transition-colors duration-300 ${
            getButtonClass()
